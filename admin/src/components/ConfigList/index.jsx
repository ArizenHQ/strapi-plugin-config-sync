      ...
      <Table colCount={4} rowCount={rows.length + 1}>
        <Thead>
          <Tr>
            <Th>
              <Checkbox
                aria-label={formatMessage({ id: 'config-sync.ConfigList.SelectAll', defaultMessage: 'Select all entries' })}
            ...
            <Th>
              <Typography variant="sigma">{formatMessage({ id: 'config-sync.ConfigList.ConfigType', defaultMessage: 'Config type' })}</Typography>
            </Th>
            <Th>
