      ...
      <Modal.Content>
        <Modal.Header>
          <Typography variant="omega" fontWeight="bold" textColor="neutral800">
            {formatMessage({ id: 'config-sync.ConfigDiff.Title', defaultMessage: 'Config changes for' })} {configName}
          </Typography>
        </Modal.Header>
        <Modal.Body>
          <Grid.Root paddingBottom={4} style={{ textAlign: 'center' }}>
            <Grid.Item col={6}>
              <Typography variant="delta" style={{ width: '100%' }}>{formatMessage({ id: 'config-sync.ConfigDiff.SyncDirectory', defaultMessage: 'Sync directory' })}</Typography>
            </Grid.Item>
            <Grid.Item col={6}>
              <Typography variant="delta" style={{ width: '100%' }}>{formatMessage({ id: 'config-sync.ConfigDiff.Database', defaultMessage: 'Database' })}</Typography>
            </Grid.Item>
          </Grid.Root>
